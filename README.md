...
|-------|-----------|---------|
|[Valorant-Zone-Stats](https://github.com/LouisAsanaka/Valorant-Zone-Stats)|A desktop program visualizing player performance across map areas in the FPS game [VALORANT](https://playvalorant.com/en-us).|![Python][python]|
